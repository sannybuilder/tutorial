...
In this tutorial we will be using the most recent versions Sanny Builder and CLEO Library. At the time of writing, it's Sanny Builder 4.2.0 and CLEO 5.2.0. Follow these steps to install or update them:
