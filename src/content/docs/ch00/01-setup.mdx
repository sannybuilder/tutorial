...
description: How to install Sanny Builder and CLEO Library for GTA San Andreas
slug: setup
---

In this tutorial we will be using the most recent versions Sanny Builder and CLEO Library. At the time of writing, it's Sanny Builder 4.2.0 and CLEO 5.4.0. Follow these steps to install or update them:
...
Also avoid paths containing non-English characters, as Sanny Builder may not work properly.
:::
...
<img src="/img/ch-00-01-1.png" alt="Sanny Builder window" />
...
<img src="/img/ch-00-01-2.png" alt="Game Directory setting" width="200"/>
...
<img src="/img/ch-00-01-3.png" alt="Game menu with CLEO" />
